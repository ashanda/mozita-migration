 ...
 *
 * This is the custom template for your homepage.
 */
...
<section class="visa-section sec-pad">
    <div class="pattern-layer" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-5.png);"></div>
    <div class="auto-container">
...
<section class="about-section p_relative">
    <div class="pattern-layer" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-6.png);"></div>
    <div class="auto-container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                <div class="image_block_one">
                    <div class="image-box p_relative d_block">
                        <figure class="image image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/resource/aboutnew2 (1).png" alt=""></figure>
                        <figure class="image image-2"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/resource/aboutnew1 (1).png" alt=""></figure>
...
<!-- team-section -->
<section class="team-section p_relative centred">
    <div class="pattern-layer">
        <div class="pattern-1" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-13.png);"></div>
        <div class="pattern-2" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-14.png);"></div>
        <div class="pattern-3" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-15.png);"></div>
    </div>
    <div class="auto-container">
...
<!-- education-section -->
<!-- <section class="education-section p_relative">
            <div class="bg-layer-2" style="background-image: url(assets/images/shape/shape-16.png);"></div>
            <div class="bg-layer parallax-bg" data-parallax='{"y": 100}' style="background-image: url(assets/images/background/education-bg.jpg);"></div>
            <figure class="image-layer wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="assets/images/resource/men-1.png" alt=""></figure>
            <div class="shape">
            ...
            <div class="auto-container">
                <div class="content_block_three">
                    <div class="content-box p_relative d_block">
                        ...
                        <ul class="country-list">
                            <li>
                                <div class="flag"><img src="assets/images/icons/flag-1.png" alt=""></div>
                                <span>United Kingdom</span>
                            </li>
                            <li>
                                <div class="flag"><img src="assets/images/icons/flag-2.png" alt=""></div>
                                <span>Canada</span>
                            </li>
                            <li>
                                <div class="flag"><img src="assets/images/icons/flag-3.png" alt=""></div>
                                <span>China</span>
                            </li>
                            <li>
                                <div class="flag"><img src="assets/images/icons/flag-4.png" alt=""></div>
                                <span>Australia</span>
                            </li>
                        </ul>
                    </div>
...
<section class="passport-section centred p_relative">
    <div class="pattern-layer">
        ...
        <div class="pattern-3" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-22.png);"></div>
    </div>
    <div class="auto-container">
